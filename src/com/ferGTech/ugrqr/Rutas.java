...
public class Rutas extends Activity
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		if ( !codqr.equals(null) && codqr.length()==11 )
		{
			...
			tv2.setText(orig+"\n"+destino);
			//Toast.makeText(getBaseContext(), cod+"PASO="+vPaso+"LATABLA="+queTabla, Toast.LENGTH_LONG).show();
		...
		//Toast.makeText(getBaseContext(), cod, Toast.LENGTH_LONG).show();
    ...
    private class ConsultaBD extends AsyncTask<String, Void, Void>
	{
	    ...
	    protected Void doInBackground(String... arg) 
	    {
	        ...
	        try 
	        {
		         ...
		         textUrl = new URL(R.string.urlConsultaRutas+"CANAL="+xCanal+"&RUTA="+cod+"&PASO="+vPaso+"&LATABLA="+queTabla);
				...
				stringBuilder.append(URLEncoder.encode(xCanal, "UTF-8"));
				stringBuilder.append(consulta2);
				
				stringBuilder.append(URLEncoder.encode(cod, "UTF-8"));
				stringBuilder.append(consulta3);
				stringBuilder.append(URLEncoder.encode(vPaso, "UTF-8"));
				stringBuilder.append(consulta4);
				stringBuilder.append(URLEncoder.encode(queTabla, "UTF-8"));
				
				consultaFinal = stringBuilder.toString();
				
				textUrl = new URL(stringBuilder.toString());
